...
class LanguagesViewController: UIViewController, Navigateble {
    ...
    private func setupUI() {
        ...
        let locale = LanguageHelper.shared.savedLocale != "en-GB" ? LanguageHelper.shared.savedLocale : "en"
        // NOTE: Not the actual links
        StaticContentPage.shared.url =
            "https://htmlpreview.github.io/?https://github.com/scalefocus/ViruSafe-static-pages/blob/master/\(locale)/about-covid.html"
        AppInfoPage.shared.url =
            "https://htmlpreview.github.io/?https://github.com/scalefocus/ViruSafe-static-pages/blob/master/\(locale)/virusafe-why.html"
