...
class BleAdvertiser: NSObject, CBPeripheralManagerDelegate, Advertiser {
    ...
    private func startAdvertisementIfNeeded() {
        ...
        case .disabled:
            ...
            print("Starting advertisement failed, scanner is disabled")
            return
        case .enabledAllTime:
    ...
    private func stopAdvertisementIfNeeded() {
        ...
        case .enabledAllTime:
            ...
            print("Stopping advertisement failed as it's forced to be enabled.")
            return
    ...
    func peripheralManager(_ peripheral: CBPeripheralManager, didAdd service: CBService, error: Error?) {
        print("Peripheral manager did add service, error: \(String(describing: error))")
        if error == nil {
    ...
    func peripheralManagerDidStartAdvertising(_ peripheral: CBPeripheralManager, error: Error?) {
        print("Peripheral manager did start advertising, error: \(String(describing: error))")
    ...
    func peripheralManager(_ peripheral: CBPeripheralManager, didReceiveRead request: CBATTRequest) {
        print("Peripheral manager did receive read, offset: \(request.offset)")
        ...
        guard request.offset <  beaconId.getData().count else {
            print("Invalid offset: \(request.offset)")
    ...
    func peripheralManager(_ peripheral: CBPeripheralManager, didReceiveWrite requests: [CBATTRequest]) {
        print("Peripheral manager did receive write(s)")
        for request in requests {
            ...
            print("write: \(value.toHexString()) from: \(request.central.identifier)")
