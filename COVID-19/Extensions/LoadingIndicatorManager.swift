...
open class LoadingIndicatorManager {
    ...
    open class func startActivityIndicator(_ activityIndicatorStyle: UIActivityIndicatorView.Style,
        ...
        if view.viewWithTag(ACTIVITY_INDICATOR_TAG_SPECIFIC_VIEW) as? UIActivityIndicatorView != nil { return }
    ...
    private func blockUI() {
        if let keyWindow = UIApplication.shared.keyWindow {
            ...
            if keyWindow.viewWithTag(ACTIVITY_INDICATOR_TAG_WHOLE_SCREEN) as? UIActivityIndicatorView != nil { return }
    ...
    class private func addConstraint(item activityIndicator: UIActivityIndicatorView, attibute: NSLayoutConstraint.Attribute, toItem superview: UIView) {
        superview.addConstraint(NSLayoutConstraint(item: activityIndicator,
                                                   attribute: attibute,
                                                   relatedBy: .equal,
                                                   toItem: superview,
                                                   attribute: attibute,
